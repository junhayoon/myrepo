...
<title>IT자료실</title>
	...
	$(document).ready(function(){
		...
		$(".write_btn").on("click", function(){
			...
			formObj.attr("action", "/itboard/write.do");
...
<body> 
	...
	<div class="container">
		<div class="content">
			<h1>IT자료실</h1>
			<hr>
				<form name="writeForm" method="post" action="/itboard/write.do" enctype="multipart/form-data">
					...
					<c:if test="${user.id != null}">
						...
						<div>					
							...
							<input type="button" class="btn btn-warning" value="취소" onclick= "location.href = '/itboard/list.do'">
						</div>
