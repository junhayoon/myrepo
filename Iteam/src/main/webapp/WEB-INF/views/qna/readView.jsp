	...
	<script type="text/javascript">	
		$(document).ready(function(){
			...
			$(".update_btn").on("click", function(){
				formObj.attr("action", "/qna/updateView.do");
			...
			$(".like_btn").on("click", function(){
				...
				formObj.attr("action", "/qna/readView.do?bno=${read.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}");
				formObj.attr("method", "post");
				formObj.submit();			
				alert("해당 글을 추천하였습니다.")
				}
			...
			$(".list_btn").on("click", function(){
				location.href = "/qna/list.do?page=${scri.page}"
			...
			$(".goReport_Btn").on("click", function(){
				location.href = "/qna/goReport.do?id=${read.writer}"
				      		  +"&perPageNum=${scri.perPageNum}"
				      		  +"&searchType=${scri.searchType}&keyword=${scri.keyword}"
			});
			...
			$(".replyUpdateBtn").on("click", function(){
				location.href = "/qna/replyUpdateView.do?bno=${read.bno}"
								+ "&page=${scri.page}"
								+ "&perPageNum=${scri.perPageNum}"
			...
			$(".replyDeleteBtn").on("click", function(){
				location.href = "/qna/replyDeleteView.do?bno=${read.bno}"
					+ "&page=${scri.page}"
					+ "&perPageNum=${scri.perPageNum}"
					+ "&searchType=${scri.searchType}"
					+ "&keyword=${scri.keyword}"
